...
> **Why not the free tier?** The free plan caps CPU time at 10ms/request. A single analysis runs ~30 external API calls, scores 157 signals, and writes results to KV/D1 — needs hundreds of ms minimum. The free tier also limits subrequests (50/request) and KV writes (1,000/day).
