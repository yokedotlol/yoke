...
server.tool(
  "yoke_analyze",
  "Analyze a domain across security, speed, DNS, SSL, email authentication, tech stack, and more. Returns comprehensive structured data with 150+ signals scored across 6 categories. Use yoke_score_summary for a concise overview instead.",
  {
    domain: z
      .string()
