// OpenAPI 3.1 spec for yoke.lol — agent discovery (ora.ai)
export const openApiSpec = {
  ...
  info: {
    ...
    version: "1.0.0",
    description:
      "Free domain intelligence & OSINT tool — 160 signals scored across 6 axes (Security, Speed, Foundations, Reputation, Discoverability, Email). No auth required for public endpoints. Cached results skip rate limits. Source: https://github.com/yokedotlol/yoke — MIT licensed.",
    license: { name: "MIT", url: "https://github.com/yokedotlol/yoke/blob/main/LICENSE" },
    contact: { name: "yoke.lol", url: "https://yoke.lol", email: "hello@yoke.lol" },
  },
  servers: [{ url: "https://yoke.lol", description: "Production" }],
  tags: [
    { name: "analysis", description: "Core domain intelligence" },
    { name: "quick", description: "Lightweight probe — no scoring" },
    { name: "subdomains", description: "Subdomain discovery" },
    { name: "enrichment", description: "Company, news, social, reverse-IP, availability" },
    { name: "ai", description: "LLM-powered analysis" },
    { name: "badge", description: "Embeddable score badges" },
    { name: "utility", description: "Health, stats, scoring methodology, docs" },
    { name: "share", description: "Share cards and PDF reports" },
  ],
  paths: {
    "/{domain}": {
      get: {
        ...
        description:
          "Enter a domain as a path (e.g., /stripe.com). Browsers get HTML, curl/API clients get JSON via Accept header or ?pretty. 20 req/hr per IP. Cache hits free.",
        parameters: [
          { name: "domain", in: "path", required: true, schema: { type: "string" }, example: "stripe.com" },
          { name: "pretty", in: "query", schema: { type: "string" }, description: "Pretty-print JSON" },
        ],
        responses: {
          "200": {
          ...
          content: {
            "application/json": {
              schema: {
                ...
                properties: { domain1: { type: "string" }, domain2: { type: "string" } },
              },
            },
          },
        },
    ...
    "/api/subdomains": {
      get: {
        ...
        responses: { "200": { description: "Subdomain list" } },
      },
      post: {
        tags: ["subdomains"],
    ...
    "/api/quick/{domain}": {
      get: {
        ...
        responses: {
          "200": { description: "Quick probe data", content: { "application/json": { schema: { type: "object" } } } },
        },
      },
    },
    "/api/ai-analysis": {
      post: {
        ...
        parameters: [
          { name: "X-OpenRouter-Key", in: "header", schema: { type: "string" }, description: "BYO OpenRouter API key" },
        ],
        responses: { "200": { description: "AI analysis (JSON or SSE)" } },
      },
    },
    "/api/ai-prompt": {
      post: {
        ...
        responses: { "200": { description: "Prompt object" }, "400": { description: "Not analyzed yet" } },
      },
    },
    "/api/company": {
      post: {
          ...
          content: {
            "application/json": {
              schema: {
                type: "object",
                required: ["domain"],
                properties: { domain: { type: "string" }, force: { type: "boolean" } },
              },
            },
          },
        },
    ...
    "/api/social": {
      post: {
        ...
        responses: { "200": { description: "Social accounts" } },
      },
    },
    "/api/reverse-ip": {
      post: {
        ...
        requestBody: {
          ...
          content: {
            "application/json": {
              schema: { type: "object", required: ["ip"], properties: { ip: { type: "string", example: "1.2.3.4" } } },
            },
          },
        },
        responses: { "200": { description: "Domains on IP" } },
      },
    },
    "/api/availability": {
      post: {
        ...
        responses: { "200": { description: "Availability regions" } },
      },
    },
    "/api/js-audit": {
      get: {
        ...
        responses: { "200": { description: "JS audit result" } },
      },
      post: {
        tags: ["analysis"],
    ...
    "/api/scoring": {
      get: {
        ...
        responses: { "200": { description: "Scoring config" } },
      },
    },
    "/api/share-sign": {
      post: {
        ...
        responses: { "200": { description: "Signed token" } },
      },
    },
    "/api/track-tab": {
      post: {
          ...
          content: {
            "application/json": {
              schema: {
                type: "object",
                required: ["tab"],
                properties: { tab: { type: "string" }, domain: { type: "string" } },
              },
            },
          },
        },
    ...
    "/badge/{domain}.svg": {
      get: {
        ...
        summary: "SVG badge",
        description:
          "Embeddable SVG. ?axis=security|speed|foundations|reputation|discoverability|email & ?label=Custom & ?style=flat-square. Cache: scored 1h, neutral 60s.",
        parameters: [
          { name: "domain", in: "path", required: true, schema: { type: "string" }, example: "example.com" },
          {
            name: "axis",
            ...
            schema: {
              type: "string",
              enum: ["security", "speed", "foundations", "reputation", "discoverability", "email"],
            },
          },
          { name: "label", in: "query", schema: { type: "string" } },
          { name: "style", in: "query", schema: { type: "string", enum: ["flat", "flat-square"] } },
        ],
    ...
    "/badge/{domain}.json": {
      get: {
        ...
        responses: { "200": { description: "Shields JSON" } },
      },
    },
    "/report/{domain}": {
      get: {
    ...
    "/.well-known/security.txt": {
      get: { tags: ["utility"], summary: "security.txt", responses: { "200": { description: "text" } } },
    },
    "/robots.txt": { get: { tags: ["utility"], summary: "robots.txt", responses: { "200": { description: "text" } } } },
    "/sitemap.xml": {
      get: { tags: ["utility"], summary: "sitemap.xml", responses: { "200": { description: "xml" } } },
    },
    "/llms.txt": { get: { tags: ["utility"], summary: "llms.txt", responses: { "200": { description: "text" } } } },
    "/status": { get: { tags: ["utility"], summary: "Status page", responses: { "200": { description: "HTML" } } } },
  },
  components: {
    schemas: {
      AnalysisResult: {
        ...
        properties: {
          ...
          domain_score: {
            ...
            properties: {
              ...
              tier: { type: "string", enum: ["Excellent", "Strong", "Moderate", "Weak", "Critical"] },
              axes: { type: "object", description: "6 axis scores" },
            },
          },
        },
      },
      ...
      BadRequest: {
        ...
        content: {
          "application/json": {
            schema: {
              type: "object",
              properties: { error: { type: "string" }, code: { type: "string" }, status: { type: "number" } },
            },
          },
        },
      },
