...
const tools: Tool[] = [
  {
    ...
    description:
      "Comprehensive domain analysis — 190+ scoring signals across 6 axes (security, speed, foundations, reputation, discoverability, email). The hub that ties everything together.",
    ...
    <div style={{ maxWidth: 800, margin: "0 auto", padding: "32px 20px 64px" }}>
      ...
      >
        ...
        <P style={{ margin: 0 }}>
          ...
          across 190+ scoring signals. The satellite tools (<strong style={{ color: "var(--text)" }}>certs</strong>,{" "}
