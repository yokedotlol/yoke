...
const REFERENCE_LINKS: Record<string, { url: string; label: string }> = {
  ...
  "forward-secrecy": { url: "https://en.wikipedia.org/wiki/Forward_secrecy", label: "Forward Secrecy" },
  "certificate-transparency": { url: "https://certificate.transparency.dev/", label: "CT Overview" },
  "cipher-suites": { url: "https://ciphersuite.info/", label: "Cipher Suite Info" },
